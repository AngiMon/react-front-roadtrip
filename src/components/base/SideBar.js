...
function SideBar (){
    ...
    return(
        <section id="sidebar">
            ...
            {/* <!-- Intro --> */}
            <section id="intro">
                <a href="/" className="logo"><img src="images/logosv2.JPG" alt="" /></a>
                <header>
                ...
                <div className="mini-posts">
                    ...
                    <article className="mini-post">
                        <header>
                            ...
                            <a href="/" className="author"><img src="images/logo_angi2.JPG" alt="" /></a>
                        </header>
                        <a href="single.html" className="image"><img src="images/sv650.JPG" alt="" /></a>
                    </article>
                </div>
            </section>
